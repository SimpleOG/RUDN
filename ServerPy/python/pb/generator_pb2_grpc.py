...
from . import generator_pb2 as generator__pb2
...
def add_FileGeneratorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'pb.FileGenerator', rpc_method_handlers)
...
class FileGenerator(object):
    ...
    def Generate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pb.FileGenerator/Generate',
